...
function runInit(wrappedDb) {
  wrappedDb.exec(`
    ...
    CREATE TABLE IF NOT EXISTS Member (id INTEGER PRIMARY KEY AUTOINCREMENT, member_type TEXT NOT NULL CHECK (member_type IN ('Student', 'Teacher')), name TEXT NOT NULL, email TEXT, phone TEXT, address TEXT, member_code TEXT UNIQUE, created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')));
