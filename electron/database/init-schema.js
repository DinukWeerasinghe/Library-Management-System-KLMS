...
function runInit(wrappedDb) {
  wrappedDb.exec(`
    ...
    CREATE TABLE IF NOT EXISTS ActivityLog (activity_id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER NOT NULL, action_type TEXT NOT NULL, description TEXT, timestamp TEXT DEFAULT (datetime('now')), FOREIGN KEY (user_id) REFERENCES User(id));
